begin
    ...
    function Prelude_46_Show_46_precCon(_123_arg_95_0_125_)
        ...
        elseif valToMatch == 109
            caseMerged = 1
        elseif valToMatch == 279
            caseMerged = 0
        elseif valToMatch == 292
            caseMerged = 5
        elseif valToMatch == 427
            caseMerged = 4
        else
            __RTS.error("pattern matching failed")
            caseMerged = nothing
    ...
    function Prelude_46_Show_46_primNumShow(_123_arg_95_0_125_, _123_arg_95_1_125_, _123_arg_95_2_125_, _123_arg_95_3_125_)
        ...
        if _valToMatch == 157
            ...
            elseif __valToMatch == 109
                _caseMerged = 1
            elseif __valToMatch == 279
                _caseMerged = 0
            elseif __valToMatch == 292
                _caseMerged = 5
            elseif __valToMatch == 427
                _caseMerged = 4
            else
                __RTS.error("pattern matching failed")
                _caseMerged = nothing
    ...
    function Main_46__123_main_95_0_125_(_123_lift_95_0_125_)
        #= C:\Users\twshe\Desktop\swap\poster\backend.jl:46 =#
        return Prelude_46_Show_46_primNumShow(nothing, _123_U_95_prim_95__95_toStrBigInt_95_1_125_(), 279, _123_lift_95_0_125_)
    end
        ...
        if valToMatch == 263
            ...
            if __RTS.is_tuple(valToMatch)
                if valToMatch == 3
                    ...
                    caseMerged = Main_46_reverse_58_revAcc_58_0(nothing, nothing, __RTS.make_tuple(3, _123_in_95_4_125_, _123_arg_95_2_125_), _123_in_95_5_125_)
                else
                    __RTS.error("pattern matching failed")
                    caseMerged = nothing
                end
